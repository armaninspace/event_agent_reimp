# Turn 2: Where do game weeks overlap with likely confounders in the weekly spending data?
...
Rejected candidates:
- `turn-02-openai-02-msa-week-coverage`
- `turn-02-openai-01-city-week-event-spending`
