# Turn 10: Which markets have enough event exposure for a careful spending comparison?

Selected candidate: `turn-10-market-coverage`

Rationale: Analysts need coverage checks before interpreting event-week comparisons.
...
Rejected candidates:
- `turn-10-crowd-spending`
- `turn-10-confounding-risk`
