# Turn 9: Which city game weeks show the largest spending lift after accounting for baseline weeks?
...
Rejected candidates:
- `turn-09-openai-02-msa-week-coverage`
- `turn-09-openai-03-identification-risk`
