# Turn 5: Which city game weeks show the largest spending lift after accounting for baseline weeks?
...
Rejected candidates:
- `turn-05-openai-02-msa-week-coverage`
- `turn-05-openai-03-identification-risk`
