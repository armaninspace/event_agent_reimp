# Turn 3: Where do game weeks overlap with likely confounders in the weekly spending data?

Selected candidate: `turn-03-openai-03-identification-risk`
...
Rejected candidates:
- `turn-03-openai-01-city-week-event-spending`
- `turn-03-openai-02-msa-week-coverage`
