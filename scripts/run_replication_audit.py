...
def main() -> int:
    ...
    parser.add_argument("--run-dir", type=Path, default=Path("app/runs/phase-033-live-openai-environment"))
    parser.add_argument("--output-dir", type=Path, default=Path("app/runs/phase-033-live-openai-environment"))
