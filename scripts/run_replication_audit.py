...
def main() -> int:
    ...
    parser.add_argument("--run-dir", type=Path, default=Path("app/runs/phase-027-notebook-knowledge-base"))
    parser.add_argument("--output-dir", type=Path, default=Path("app/runs/phase-027-notebook-knowledge-base"))
