...
def main() -> int:
    ...
    parser.add_argument("--run-dir", type=Path, default=Path("app/runs/phase-022-business-statistical-tables"))
    parser.add_argument("--output-dir", type=Path, default=Path("app/runs/phase-022-business-statistical-tables"))
